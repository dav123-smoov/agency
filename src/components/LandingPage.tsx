        ...
        <div className="hero-inner">
          <div className="hero-content">
            <div className="hero-badge">
              ...
              <span className="hero-badge-text">WELCOME TO TEKZ IT SOLUTION</span>
            </div>
            <h1 className="hero-heading">
              We Build Ideas Driven<br />by the Future<span className="dot-accent">.</span>
            </h1>
            <p className="hero-subtext">
              we understand the importance of financial planning for individuals<br />
          ...
          <div className="features-grid">
            {[
              ...
              <div className="feature-card" key={i}>
                ...
                <a href="#" className="feature-read-more">Read More &#8594;</a>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="section-inner about-inner">
          ...
          <div className="about-content">
            ...
            <p className="about-desc">
              Deliver beautiful emails that get opened and clicked every time. Personalized
              content to every subscriber. Fully customizable templates. Build relationships that
              lead to conversions.
            </p>
            <div className="about-feature-item-new">
              ...
              <div className="about-feature-text">
                <h4 className="about-feature-title-new">Best Technical Solution</h4>
            ...
            <a href="#" className="btn-primary-about">Get Our Services</a>
          </div>
        </div>
      </section>
        ...
        <div className="section-inner">
          ...
          <div className="services-layout">
            <div className="services-text-col">
              ...
              <h3 className="services-sub-heading">Analytics Overview You've Always Wanted</h3>
              <div className="services-feature-list">
                {[
                  { title: 'Tailored Solutions for Every Business', desc: 'Our digital marketing agency is dedicated to transforming online potential into tangible success' },
                  { title: 'Dedicated Client Success Team', desc: 'Our digital marketing agency is dedicated to transforming online potential into tangible success' },
                  { title: 'Sustainability-Focused IT Practices', desc: 'Our digital marketing agency is dedicated to transforming online potential into tangible success' },
                ].map((item, i) => (
      ...
      <section className="team-section">
        <div className="section-inner">
          ...
          <div className="team-grid">
            {[
              { name: 'Victoria Mansfield', role: 'IT Director', img: 'https://api.builder.io/api/v1/image/assets/TEMP/ef7a21aa65e0b26ee5d400acffb0f3a703611aae?width=820' },
              { name: 'William Harrison', role: 'Cybersecurity Analyst', img: 'https://api.builder.io/api/v1/image/assets/TEMP/10afe836e594e17ddcdac4cc363c1cebfe4e9803?width=820' },
              { name: 'Olivia Spencer', role: 'Software Developer', img: 'https://api.builder.io/api/v1/image/assets/TEMP/ef7a21aa65e0b26ee5d400acffb0f3a703611aae?width=820' },
            ].map((member, i) => (
        ...
        <div className="section-inner cta-inner">
          <div className="cta-content">
            ...
            <h2 className="cta-heading">
              ...
              the financial best interests<br />
              with automation
            </h2>
      ...
      <section className="projects-section">
        ...
        <div className="section-inner projects-inner">
          ...
          <div className="projects-list">
            {[
              { title: 'Renewable Energy Landing Page', img: 'https://api.builder.io/api/v1/image/assets/TEMP/3602d34cde61908739f4a4f5fd48e5ef5aa699fd?width=972', desc: 'See the power of data in action as we break down how analytics driven decisions led to a surge in campaign effectiveness.' },
              { title: 'Based Digital Identity Management', img: 'https://api.builder.io/api/v1/image/assets/TEMP/9e6bdcc8e309b497dbe7a64e02620c4c886ec00f?width=972', desc: 'See the power of data in action as we break down how analytics driven decisions led to a surge in campaign effectiveness.' },
              { title: 'Healthcare Management & Telemedicine', img: 'https://api.builder.io/api/v1/image/assets/TEMP/25cc36a4154d039ba06b6af36bf4c1508afcc45d?width=1080', desc: 'See the power of data in action as we break down how analytics driven decisions led to a surge in campaign effectiveness.' },
            ].map((proj, i) => (
              <div className="project-card" key={i}>
                <div className="project-card-body">
                  ...
                  <a href="#" className="btn-primary project-btn">Read Full Case Study</a>
                </div>
      ...
      <section className="testimonials-section">
        ...
        <div className="section-inner testimonials-inner">
          ...
          <div className="testimonial-slider">
            <button className="testimonial-arrow testimonial-arrow--prev">&larr;</button>
            <div className="testimonial-card">
              <div className="testimonial-card-top">
                <div className="testimonial-quote-icon">❝</div>
                <p className="testimonial-text">
                  "We pride ourselves on delivering cutting-edge IT solutions that empower businesses
                  to scale, optimize efficiency, and enhance security. Here's what one of our valued
                  clients had to say about their experience working with us."
                </p>
              </div>
              <div className="testimonial-author-row">
                <img
                  src="https://api.builder.io/api/v1/image/assets/TEMP/ed85b22c835aca1b0ff80954f150b0bd0b69115f?width=120"
                  alt="Thomas Richard Ellington"
                  className="testimonial-avatar"
                  style={{ width: '48px', height: '48px' }}
                />
                <div>
                  <p className="testimonial-name">Thomas Richard Ellington</p>
                  <p className="testimonial-role">Cloud Solutions Architect</p>
                </div>
                <div className="testimonial-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
              </div>
            </div>
            <button className="testimonial-arrow testimonial-arrow--next">&rarr;</button>
          </div>
        </div>
      </section>
      ...
      <section className="blog-section">
        <div className="section-inner">
          ...
          <div className="blog-grid">
            {[
              { img: 'https://api.builder.io/api/v1/image/assets/TEMP/6e76bea5071b91488244378e1e6394801b520807?width=817', title: 'The Importance of Cybersecurity Services from IT Experts', date: 'January 10, 2024' },
              { img: 'https://api.builder.io/api/v1/image/assets/TEMP/f06a68f39723a1e20137a9516a5407c8daa02131?width=817', title: 'How Custom Software Development Is Changing the Game', date: 'January 10, 2024' },
              { img: 'https://api.builder.io/api/v1/image/assets/TEMP/6e4bd2a7d42139dd72ffddc1f0e5052adc5d32fb?width=817', title: 'How Emerging Technologies Are Reshaping Business', date: 'January 10, 2024' },
            ].map((post, i) => (
