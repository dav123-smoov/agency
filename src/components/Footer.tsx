            ...
            <div className="section-inner footer-inner">
                <div className="footer-brand-col">
                    ...
                    <div className="footer-socials">
                        <a href="https://www.instagram.com/daqswebagency/" target="_blank" rel="noopener noreferrer" className="footer-social-btn" title="Instagram">
                        ...
                        <a href="https://www.tiktok.com/@daqswebagency?_r=1&_t=ZS-98pAvJpz4ej" target="_blank" rel="noopener noreferrer" className="footer-social-btn" title="TikTok">
                        ...
                        <a href="https://www.linkedin.com/in/bolaji-david-23b1692a4" target="_blank" rel="noopener noreferrer" className="footer-social-btn" title="LinkedIn">
                        ...
                        <a href="https://wa.me/2347038904187" target="_blank" rel="noopener noreferrer" className="footer-social-btn" title="WhatsApp">
                ...
                <div className="footer-col">
                    ...
                    <ul className="footer-contact-list">
                        <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"></path><circle cx="12" cy="10" r="3"></circle></svg> Walter Carrington Cres, V.I, Lagos</li>
                        <li className="footer-call-row">Call Us: <a href="tel:+2347048043844" className="footer-call-icon-btn" title="Call Us" aria-label="Call Us"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"></path></svg></a></li>
